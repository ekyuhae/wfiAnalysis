function [moved,combined] = imalign_s(moving, fixed,selectedMovingPoints,selectedFixedPoints)
...
%     end
    ...
    %% Fuse
%     combined = imfuse(moved, fixed, 'blend','Scaling','joint');

%% Changed---------------
combined = imfuse(moved, fixed, 'blend','Scaling','joint');
combined=histeq(combined); % EK modify contrast? why
...
% low = 0.3;
% high = 0.7;
% combined = imadjust(combined,[low high],[]); % I is double
