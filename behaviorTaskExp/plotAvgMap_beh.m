function plotAvgMap_beh (contrasts, avgStimResponse, coordinates, sPath, type)
...
savefig(m,  ['avgActivityMap_binoc_' type 'Trials.fig']);
...
savefig(f, ['avgActivityMap_monoc_' type 'Trials.fig']);
