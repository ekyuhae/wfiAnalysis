...
[avgStimResponse, avgTempTrace, binocOnFrame, monocOnFrame] = barmapMultiCont_gratings(paramSorted, allData, bFrameTimes, savePath, 6, img,sessNr, expID_ret, flag); % you can also apply full contrast grating
