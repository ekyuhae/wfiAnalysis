function plotDffTracesAndPeaks_beh(type, Animal, expID, hva, flag)
% Inputs:
...
try %load previously compiled data or add on new dates if necessary
    ...
    [comp, nrSessions, newExpNr] = compileAnalyzedData_NA (fPath, Animal, explist, gratings, hva, flag); % changed from expID to explist EK
end
